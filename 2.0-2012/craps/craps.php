...
<title>Craps</title>
<link href="crapstylePL.css" rel="stylesheet" type="text/css">
...
if (is_numeric($_POST['bet']))
{
		...
		elseif  ($roll1 == 2 || $roll1 == 3 || $roll1 == 12)
		{
			echo 'You rolled a ' . $roll1 . '<br />';
			echo '<span class = "losetext">You Crapped Out! You Lose. </span><br />';
			echo 'You now have $0!';
			...
			echo 'You rolled a ' . $roll1 . '<br />';
			echo " <form name = 'rollagain'  method = 'post' action = 'rollagain.php'>You need a <input type = 'text' size = '2' name = 'roll'  value = $roll1 readonly> <br />";
			echo 'Roll Again <br />';
			echo "You wagered &nbsp;  \$<input type = 'text' size = '10' name = 'bet'  value = $bet readonly> &nbsp; &nbsp; Pass Line <br />
