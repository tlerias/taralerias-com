...
<input type = 'submit' name = 'Submit' value = 'Play Again'  />
		...
		{
			echo 'You rolled a ' . $rollAgain . '<br />';
			echo '<span class = "losetext"> Seven out! You Lose. </span><br />';
			echo 'You now have $0!';
...
<input type = 'submit' name = 'Submit' value = 'Play Again'  />
		...
		{
			echo 'You rolled a ' . $rollAgain . '<br />';
			echo "<form name = 'rollagain'  method = 'post' action = 'rollagain.php'>You need a  <input type = 'text' size = '2' name = 'roll'  value = $roll2 readonly>  <br />";
			echo 'Roll Again <br />';
