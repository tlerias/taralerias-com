...
<title>Brand Audits - Kinsey Durham</title>
...
<div id = "logo">
 ...
 <div id = "work1"> 
    <img src = "images/brandaudits1.jpg" alt = "Work" />
</div>
                     <div id="Contentlong">
                     ...
                     <?php
						...
						$sql = "SELECT name, path FROM brandaudits";
...
while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC))
	...
	$path = $row['path'];
	$name = $row['name'];
	echo '<a target = "_blank" href =' . $path . '>' . $name . '</a> <br />';
